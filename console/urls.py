...
urlpatterns = [
    ...
    path("orders/<str:order_number>/resend-confirmation/", views.OrderResendConfirmationView.as_view(), name="order_resend_confirmation"),
    ...
    path("emails/", views.OutboxListView.as_view(), name="emails"),
    path("emails/<int:pk>/retry/", views.OutboxRetryView.as_view(), name="email_retry"),
